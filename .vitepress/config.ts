  ...
  '/guide/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Backup Providers', link: '/guide/backup/providers' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'PWA Features', link: '/guide/client/pwa' },
        { text: 'Offline Usage', link: '/guide/client/offline-usage' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Durable Objects', link: '/guide/architecture/durable-objects' },
  ...
  '/zh/guide/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '备份服务商', link: '/zh/guide/backup/providers' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'PWA 功能', link: '/zh/guide/client/pwa' },
        { text: '离线使用', link: '/zh/guide/client/offline-usage' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Durable Objects', link: '/zh/guide/architecture/durable-objects' },
